...
class CorsResponseEventSubscriber implements EventSubscriberInterface {
   ...
   *
   * @var \Drupal\Core\path_alias\AliasManager
   */
   ...
   *   The config factory.
   * @param \Drupal\Core\path_alias\AliasManager $alias_manager
   *   The alias manager.
   * @param \Drupal\Core\Path\PathMatcherInterface $path_matcher
   *   The path matcher.
   */
  public function __construct(ConfigFactoryInterface $config_factory, AliasManager $alias_manager, PathMatcherInterface $path_matcher) {
